...
// Определяем один раз на глобальном объекте
...
// Функция для одной буквы
window.getLetterScore = function(char) {
  // Исправлено: возвращаем 0, если буквы нет
  return window.SCRABBLE_SCORES[char.toUpperCase()] || 0;
};

// Функция для всего слова (теперь она использует getLetterScore)
